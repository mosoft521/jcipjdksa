package coding.interview.guide.chapter_3_binarytreeproblem;
...
public class Problem_19_TarjanAndDisjointSetsForLCA {
    ...
    public static class Tarjan {
        private final HashMap<Node, LinkedList<Node>> queryMap;
        private final HashMap<Node, LinkedList<Integer>> indexMap;
        private final HashMap<Node, Node> ancestorMap;
        private final DisjointSets sets;
