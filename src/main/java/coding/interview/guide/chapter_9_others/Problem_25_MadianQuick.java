package coding.interview.guide.chapter_9_others;
...
public class Problem_25_MadianQuick {
    ...
    public static class MedianHolder {
        private final MyHeap<Integer> minHeap;
        private final MyHeap<Integer> maxHeap;
    ...
    public static class MyHeap<K> {
        ...
        private final Comparator<K> comp; // max-heap or min-heap
